#There are four biological replicates:VZ_P0_10X_rep1, VZ_P5_10X_rep1, VZ_P0_10X_rep2 and VZ_P5_10X_rep2.Here VZ_P0_10X_rep2 file was used as an example.
...
--readFilesIn VZ_P0_10X_rep1_R2.fastq.gz VZ_P0_10X_rep1_R1.fastq.gz \
...
#3-6 Trajectory analysis (Monocle)
...
#3-7 Differential expression analysis on branches (Monocle)
Branch_diff <- BEAM(cds_10X_integrated)
Branch_diff<- Branch_diff[order(Branch_diff$qval),]

#3-8 Differential expression analysis on clusters (Seurat)
...
sce_10X@active.ident<-sce_10X$harmonny_clusters
#3-11-1 Marker gene identification for NSC clusters
sce_10X_NSC<-sce_10X[,sce_10X$harmonny_clusters ==2|
                      sce_10X$harmonny_clusters ==4|
                      sce_10X$harmonny_clusters ==6|
                      sce_10X$harmonny_clusters ==12]
NSC_cluster_markers<-FindAllMarkers(sce_10X_NSC,only.pos = TRUE)
#3-11-2 Marker gene identification for EPC clusters
sce_10X_EPC<-sce_10X[,sce_10X$harmonny_clusters ==8|
                      sce_10X$harmonny_clusters ==9]
EPC_cluster_markers<-FindAllMarkers(sce_10X_EPC,only.pos = TRUE)

#3-9 GO enrichment analysis (clusterProfiler)
