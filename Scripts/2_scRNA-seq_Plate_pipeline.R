#There are two replicates.Replicate1 contains five plates (VZ_P0_rep1_plateA,B,C,D,E) and replicate2 contains three plates (VZ_P0_rep2_plateA,B,C).Here VZ_P0_rep1_plateA is used as an example.
...
--readFilesIn VZ_P0_rep1_plateA_R2.fastq.gz VZ_P0_rep1_plateA_R1.fastq.gz \
...
rep1_plateA_counts <- Read10X(data.dir = '/Solo.out/Gene/filtered')
sce_rep1_plateA <- CreateSeuratObject(counts=rep1_plateA_counts, 
                                      project = "sce_rep1_plateA")
sce_rep1 <- merge(sce_rep1_plateA,
                y=c(sce_rep1_plateB, sce_rep1_plateC, sce_rep1_plateD, sce_rep1_plateE),
                add.cell.ids = c("plateA", "plateB","plateC","plateD","plateE"), 
                project = "rep1")
