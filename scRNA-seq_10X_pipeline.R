...
cds_10X <- cds_10X [,!(cds_10X $Cluster=="8"| 
                       cds_10X $Cluster=="3")]
#Cells of Cluster8 and Cluster3 were excluded from subsequent analysis.
...
plot_cell_clusters(cds_10X)
sce_10X<- sce_10X [,!(sce_10X $monocle_clusters=="8"| sce_10X $monocle_clusters=="3")]
sce_10X$monocle_clusters<-cds_10X$Cluster
VlnPlot(sce_10X,features=c("nFeature_RNA","nCount_RNA","mitopercent"),group.by="monocle_clusters")
cds_10X <- cds_10X [,!(cds_10X $Cluster=="8"| cds_10X $Cluster=="11")]
...
sce_10X <- sce_10X[,!(sce_10X$monocle_clusters=="8"|sce_10X$monocle_clusters=="11")]
sce_10X <- NormalizeData(sce_10X) 
sce_10X <- FindVariableFeatures(sce_10X, nfeatures = 2000)
sce_10X <- ScaleData(sce_10X,vars.to.regress ="nCount_RNA") 
sce_10X@active.ident<-sce_10X$monocle_clusters_filter5
